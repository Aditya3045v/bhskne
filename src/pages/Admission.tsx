  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const applicationData = {
        ...
        address: `${values.address_line1}, ${values.address_line2 || ''}, ${values.city}, ${values.state} - ${values.pincode}`,
        mobile: values.father_mobile,
        email: user.email || '',
        ...
        academic_year: values.academic_year.toString(),
