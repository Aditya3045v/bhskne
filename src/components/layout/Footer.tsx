  ...
  return <footer className="bg-school-blue-dark text-white">
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="h-10 w-10 bg-white rounded-full flex items-center justify-center">
                <span className="text-school-blue-dark font-bold text-lg">बालिका उच्च विद्यालय - डूमरिया, किशनगंज, बिहार</span>
              </div>
              <h3 className="text-xl font-bold">Balika High School</h3>
            </div>
            <p className="text-sm text-gray-300 mb-4">
              Kishanganj. Providing quality education since 1968.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Balika High School. All Rights Reserved.</p>
          <p className="mt-2">
            Developed and Maintained by IT Department, Balika High School
          </p>
        </div>
      </div>
    </footer>;
