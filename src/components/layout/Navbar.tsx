        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-center md:text-left font-semibold text-lg md:text-xl">बालिका मध्य विद्यालय, डूमरिया किशनगंज, बिहार, 855107</h1>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-2 mt-2 md:mt-0 text-xs md:text-sm">
              <div className="bg-gray-100 px-2 py-1 rounded">
                <span className="font-semibold">UDISE CODE:</span> 10082109404
              </div>
              <div className="bg-gray-100 px-2 py-1 rounded">
                <span className="font-semibold">INTER SCHOOL CODE:</span> 93036
              </div>
              <div className="bg-gray-100 px-2 py-1 rounded">
                <span className="font-semibold">MATRIC SCHOOL CODE:</span> 13009
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:hidden bg-white border-t border-gray-200 py-2">
          <div className="container mx-auto px-4">
            <div className="flex flex-col space-y-2">
              ...
              {isAdmin && (
                <Link to="/admin" className="px-3 py-2 text-sm font-medium text-white bg-school-blue hover:bg-school-blue-dark rounded-md flex items-center" onClick={() => setMobileMenuOpen(false)}>
